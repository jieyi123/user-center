package com.pjieyi.usercenter.utils;
...
public class AliyunIdentifyCode {
    //1.验证参数信息
    private static final String captchaId="cf6ae8259eb05cfae171b2bd6d18bd62"; //appId
    private static final String captchaKey="66844ecf12b14aae224fc7cb1fdf2a7c"; //appKey
